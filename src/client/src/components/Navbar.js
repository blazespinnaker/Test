          ...
          {/* START LINK MENU */}
           ...
           <Link to="/interestses">
            <ListItem button key="Interests">
              ...
              <ListItemText className="menu-text" primary="Interests" />
            </ListItem>
          </Link>{" "}            
           <Link to="/qualitieses">
            <ListItem button key="Qualities">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Qualities" />
            </ListItem>
          </Link>{" "}            
           <Link to="/scoreses">
            <ListItem button key="Scores">
              ...
              <ListItemText className="menu-text" primary="Scores" />
            </ListItem>
          </Link>{" "} {/* END LINK MENU */}
        </List>
      </div>
