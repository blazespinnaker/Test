...
class DialogChangePwdAdmin extends Component {
  ...
  confirm() {
    if (!this.state.user.newPassword) {
    ...
    } else if (!this.state.user.adminPassword) {
      this.setState({
        showError: "Insert the admin password"
      });
    } else if (
      ...
      this.props.actionsUser
        .changePasswordAdmin(
          this.props.idUser,
          crypto.sha3_512(this.state.user.adminPassword),
      ...
      >
        ...
        <DialogContent>
          <TextField
            ...
            value={this.state.user.adminPassword || ""}
