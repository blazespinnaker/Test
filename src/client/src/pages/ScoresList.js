...
class ScoresList extends Component {
  ...
  // Load data on start
  componentWillMount() {
    this.props.actionsScores.loadScoresList();
  }
  ...
  confirmDialogDelete(id) {
    this.props.actionsScores.deleteScores(this.state.idDelete).then(data => {
      this.props.actionsScores.loadScoresList();
      this.setState({ openDialogDelete: false, idDelete: null });
    });
  }
            ...
            {this.props.list.map(row => (
              <TableRow key={row._id}>
                <TableCell component="th" scope="row">
                  <Link to={"/scoreses/" + row._id} key={row._id}>
                    {row._id}
                  </Link>
                </TableCell>
              </TableRow>
...
function mapStateToProps(state, ownProps) {
  return {
    list: state.ScoresListReducer.listScores
  };
}
